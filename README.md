...
This package is intended to be used as a Lambda-based Bib Service using the [NYPL PHP Microservice Starter](https://github.com/NYPL/php-microservice-starter).
