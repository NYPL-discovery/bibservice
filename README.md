...
This package is intended to be used as Lambda-based Bib Service using the [NYPL PHP Microservice Starter](https://github.com/NYPL/php-microservice-starter).
